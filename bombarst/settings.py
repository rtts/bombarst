...
DEFAULT_TO_EMAIL = ["ikwild@debombarst.nl", "jj@rtts.eu"]
CONTACT_FORM_EMAIL_SUBJECT = "Contactformulier Bombarst.nl"
CONTACT_FORM_EMAIL_ADDRESS = "ikwild@debombarst.nl"
ALLOWED_HOSTS = ["*"]
